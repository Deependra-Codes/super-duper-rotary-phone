...
- HTML, CSS, JavaScript
- Leaflet.js for the journey map
- p5.js for the terminal Snake game
...
```text
http://127.0.0.1:8000/
http://127.0.0.1:8000/terminal.html
```

## Deployment Notes

`CNAME` and `sitemap.xml` were removed because no verified deployment domain was available in the resume. Add them back after choosing the final domain.

## Attribution

This portfolio is adapted from the original neo-brutalist portfolio by Marjo Ballabani:

`https://github.com/marjoballabani/marjoballabani.me`

Original design/code rights remain with the original author. Deependra Rathod's resume content, contact information, and generated portrait asset are separate portfolio content.
